...
It renames all the occurrences of CartPole (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the CartPole folder
        os.rename(
            os.path.join(root_dir_path, "exts", "CartPole", "CartPole"),
            os.path.join(root_dir_path, "exts", "CartPole", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "CartPole"), os.path.join(root_dir_path, "exts", new_name))
